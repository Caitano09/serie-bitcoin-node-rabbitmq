...
var Perioad_1 = __importDefault(require("./enums/Perioad"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                loopTimes = Perioad_1.default.FIVE_MINUTES / Perioad_1.default.TEN_SECONDS;
            ...
            case 4:
                ...
                return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, Perioad_1.default.TEN_SECONDS); })];
            case 5:
                _a.sent();
                _a.label = 6;
            case 6:
